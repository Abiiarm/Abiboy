  ...
  return (function (t) {
    ...
    1: function (t, e, i) {
      ...
      (r.VantaBase = class {
        constructor(t = {}) {
          ...
          if (
            ((this.options = Object(n.c)({ mouseControls: !0, touchControls: !0, gyroControls: !1, minHeight: 200, minWidth: 200, scale: 1, scaleMobile: 1 }, e)),
          ...
          try {
            ...
            return (
              ...
              void (this.options.backgroundColor && (console.log('[VANTA] Falling back to backgroundColor'), (this.el.style.background = Object(n.a)(this.options.backgroundColor))))
            );
          }
        ...
        applyCanvasStyles(t, e = {}) {
          Object(n.c)(t.style, { position: 'absolute', zIndex: 0, top: 0, left: 0, background: '' }), Object(n.c)(t.style, e), t.classList.add('vanta-canvas');
        }
        initThree() {
          s.WebGLRenderer
        ...
        setSize() {
          this.scale || (this.scale = 1),
            Object(n.e)() && this.options.scaleMobile ? (this.scale = this.options.scaleMobile) : this.options.scale && (this.scale = this.options.scale),
    ...
    18: function (t, e, i) {
      ...
      let s = 'object' == typeof window && window.THREE,
        { Camera: r, ClampToEdgeWrapping: a, DataTexture: l, FloatType: h, Mesh: c, NearestFilter: u, PlaneBufferGeometry: d, RGBAFormat: p, Scene: f, ShaderMaterial: m, WebGLRenderTarget: v } = s || {};
      var y = function (t, e, i, n) {
        n && ({ Camera: r, ClampToEdgeWrapping: a, DataTexture: l, FloatType: h, Mesh: c, NearestFilter: u, PlaneBufferGeometry: d, RGBAFormat: p, Scene: f, ShaderMaterial: m, WebGLRenderTarget: v } = n),
          (this.variables = []),
        ...
        function M(t, e) {
          var i = new m({ uniforms: (e = e || {}), vertexShader: 'void main()\t{\n\n\tgl_Position = vec4( position, 1.0 );\n\n}\n', fragmentShader: t });
          return x(i), i;
        }
        s.add(b),
          ...
          (this.addVariable = function (t, e, i) {
            var n = { name: t, initialValueTexture: i, material: this.createShaderMaterial(e), dependencies: null, renderTargets: [], wrapS: null, wrapT: null, minFilter: u, magFilter: u };
          ...
          (this.init = function () {
            ...
            for (var n = 0; n < this.variables.length; n++) {
              ...
              (o.renderTargets[0] = this.createRenderTarget(t, e, o.wrapS, o.wrapT, o.minFilter, o.magFilter)),
                (o.renderTargets[1] = this.createRenderTarget(t, e, o.wrapS, o.wrapT, o.minFilter, o.magFilter)),
          ...
          (this.createRenderTarget = function (i, n, s, r, l, h) {
            return new v((i = i || t), (n = n || e), { wrapS: (s = s || a), wrapT: (r = r || a), minFilter: (l = l || u), magFilter: (h = h || u), format: p, type: o, stencilBuffer: !1, depthBuffer: !1 });
          }),
            ...
            (S = function (e) {
              ...
              (this.position = new t.Vector3()),
                ...
                (this.flock = function (t) {
                  n && i.add(this.reach(n, 0.005)), i.add(this.alignment(t)), i.add(this.cohesion(t)), i.add(this.separation(t));
                }),
                (this.move = function () {
                  this.velocity.add(i);
                ...
                (this.repulse = function (e) {
                  ...
                  if (n < 150) {
                    var o = new t.Vector3();
                    o.subVectors(this.position, e), o.multiplyScalar(0.5 / n), i.add(o);
                  }
                }),
                ...
                (this.alignment = function (e) {
                  ...
                  for (var a = 0, h = e.length; a < h; a++) Math.random() > 0.6 || ((n = (i = e[a]).position.distanceTo(this.position)) > 0 && n <= r && (o.add(i.velocity), s++));
                  if (s > 0) {
                    o.divideScalar(s);
                    var c = o.length();
                ...
                (this.cohesion = function (e) {
                  ...
                  for (var h = 0, c = e.length; h < c; h++) Math.random() > 0.6 || ((n = (i = e[h]).position.distanceTo(this.position)) > 0 && n <= a && (o.add(i.position), r++));
                ...
                (this.separation = function (e) {
                  ...
                  for (var a = 0, h = e.length; a < h; a++) Math.random() > 0.6 || ((n = (i = e[a]).position.distanceTo(this.position)) > 0 && n <= r && (s.subVectors(this.position, i.position), s.normalize(), s.divideScalar(n), o.add(s)));
                  return o;
                });
            }),
      ...
      class A extends n.b {
        ...
        initComputeRenderer() {
          ...
          D(t),
            O(e),
            (this.velocityVariable = this.gpuCompute.addVariable('textureVelocity', R, e)),
            (this.positionVariable = this.gpuCompute.addVariable('texturePosition', V, t)),
        ...
        initGpgpuBirds() {
          ...
          this.birdUniforms = { color: { value: new g.Color(16720384) }, texturePosition: { value: null }, textureVelocity: { value: null }, time: { value: 1 }, delta: { value: 0 }, birdSize: { value: this.options.birdSize } };
          const i = new g.ShaderMaterial({ uniforms: this.birdUniforms, vertexShader: E, fragmentShader: P, side: g.DoubleSide }),
            n = new g.Mesh(e, i);
        ...
        onInit() {
          ...
          if (w)
            ...
            for (var s = 0; s < l; s++) {
              ...
              ((o = t[s] = new g.Mesh(c, new g.MeshBasicMaterial({ color: 16777215, side: g.DoubleSide, vertexColors: g.VertexColors }))).phase = Math.floor(62.83 * Math.random())),
        ...
        onUpdate() {
          ...
          if ((t > 1 && (t = 1), (this.last = this.now), w))
            ...
            for (var e = 0, i = t.length; e < i; e++)
              (o = n[e]).run(n),
                ((s = t[e]).rotation.y = Math.atan2(-o.velocity.z, o.velocity.x)),
                (s.rotation.z = Math.asin(o.velocity.y / o.velocity.length())),
                (s.phase = (s.phase + (Math.max(0, s.rotation.z) + 0.1)) % 62.83),
                (s.geometry.vertices[5].y = s.geometry.vertices[4].y = 5 * Math.sin(s.phase) * this.options.birdSize),
